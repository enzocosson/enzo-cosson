...
export const profile = {
  name: 'Enzo Cosson',
  role: 'Développeur front-end chez FDJ UNITED & créateur de SaaS',
  location: 'Paris et périphérie',
  email: 'enzolemercier@gmail.com',
  phone: '+33 6 51 84 58 69',
  status: 'Développeur front-end — FDJ UNITED',
  intro:
    "Développeur front-end chez FDJ UNITED et créateur de DeepEdge, un SaaS analytics pour options traders. Je conçois des interfaces web performantes avec React et collabore sur des projets à fort trafic.",
  about:
    "Développeur front-end chez FDJ UNITED et créateur de DeepEdge, un SaaS analytics pour options traders. Je conçois des applications web performantes et scalables : React/Redux en frontend, Node.js/Express et Python en backend, bases de données NoSQL/SQL, WebSockets temps réel, paiements Stripe et déploiement cloud. Mon SaaS, DeepEdge, compte plus de 600 utilisateurs et près de 60 000 lignes de code. Passionné par le design, la data viz et la performance, je cherche à contribuer sur des projets complexes et ambitieux.",
}
...
export const projects = [
  ...
  },
  {
    ...
    year: '2026',
    description:
      "Développement de l'interface « Compte Joueur » de la FDJ en React.js : nouvelles fonctionnalités, corrections de bugs, refactoring et optimisation du code au sein d'une équipe agile.",
  ...
  },
  {
    ...
    technologies: ['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'IA / LLM'],
  ...
  },
  {
    ...
    technologies: ['React Js', 'Three Js', 'React Three Fiber', 'Sass', 'Blender', 'gsap'],
  ...
  },
  {
    ...
    technologies: ['React Js', 'Three Js', 'Sass', 'Blender', 'gsap', 'Voiceflow', 'Vercel'],
...
export const services = [
  'Développement front-end React / Vue',
...
export const experiences = [
  {
    ...
    endDate: null,
    description:
      "Contribution au développement de l'interface « Compte Joueur » de la FDJ en React.js : nouvelles fonctionnalités, corrections de bugs, refactoring et optimisation du code. Collaboration avec les développeurs, Product Owners et QA via un stack moderne incluant React, Redux, Figma, Directus CMS, GitLab et Jira.",
  ...
  },
  {
    ...
    skills: ['React.js', 'Node.js', 'WebSocket', 'Python', 'Stripe', 'MongoDB', 'Sass', 'Directus'],
